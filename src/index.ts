import type { Color, DrawingType, Repetition, ColorStop, LineStyle, Point, Shadow, Dimensions, Scale, TextStyle, Dash, Rect } from './properties';
...
export type { Color, DrawingType, Repetition, ColorStop, LineStyle, Point, Shadow, Dimensions, Scale, TextStyle, Dash, Rect as Rectangle };
